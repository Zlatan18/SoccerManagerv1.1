package com.example.soccermanager.activity.user;
...
import com.example.soccermanager.activity.admin.ListServiceActivity;
import com.example.soccermanager.activity.admin.MainActivity;
import com.example.soccermanager.activity.admin.ShowCaThiDauActivity;
...
public class UserDatSanChiTietActivity extends AppCompatActivity {
    ...
    public void setOnCLickForView() {
        tvDate.setOnClickListener(v -> {
            if (!isUpdate) {
                if(count>0){
                    Toast.makeText(UserDatSanChiTietActivity.this, "Bạn cần hủy lịch của ngày " + datePlay, Toast.LENGTH_SHORT).show();
                }else {
